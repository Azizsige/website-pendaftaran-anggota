  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <div className="bg-surface-container-lowest rounded-xl border border-outline-variant/30 p-5 flex flex-col gap-2 relative overflow-hidden shadow-sm">
        ...
        <span className="font-display-sm text-[32px] font-bold text-on-surface">
          {loading ? <div className="h-9 w-20 bg-surface-variant/50 animate-pulse rounded mt-1"></div> : summary.total}
        </span>
      </div>
      <div className="bg-primary/5 rounded-xl border border-primary/20 p-5 flex flex-col gap-2 relative overflow-hidden shadow-sm">
        ...
        <span className="font-display-sm text-[32px] font-bold text-primary">
          {loading ? <div className="h-9 w-20 bg-surface-variant/50 animate-pulse rounded mt-1"></div> : summary.approved}
        </span>
      </div>
      <div className="bg-secondary/5 rounded-xl border border-secondary/20 p-5 flex flex-col gap-2 relative overflow-hidden shadow-sm">
        ...
        <span className="font-display-sm text-[32px] font-bold text-secondary">
          {loading ? <div className="h-9 w-20 bg-surface-variant/50 animate-pulse rounded mt-1"></div> : summary.pending}
        </span>
      </div>
      <div className="bg-error/5 rounded-xl border border-error/20 p-5 flex flex-col gap-2 relative overflow-hidden shadow-sm">
        ...
        <span className="font-display-sm text-[32px] font-bold text-error">
          {loading ? <div className="h-9 w-20 bg-surface-variant/30 animate-pulse rounded mt-1"></div> : summary.rejected}
        </span>
      </div>
    </div>
  );
